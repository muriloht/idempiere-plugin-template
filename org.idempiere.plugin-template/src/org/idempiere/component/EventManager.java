...
import org.idempiere.base.CustomEventManager;
...
public class EventManager extends CustomEventManager {
	...
	@Override
	protected void initialize() {
		registerTableEvent(DOC_BEFORE_COMPLETE, org.idempiere.model.MTableDocTemplate.Table_Name, org.idempiere.event.EPrintPluginInfo.class);
	}
